...
Two of those 23 come from interaction probes a static DOM scanner cannot perform. The
remaining 32 require a human — `ratchet manual` will generate you a checklist.

Two of the 17 Partial criteria (1.3.4, 2.5.3) rest on rules axe marks experimental; the
generated table flags them.
